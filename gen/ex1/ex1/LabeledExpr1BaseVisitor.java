...
public class LabeledExpr1BaseVisitor<T> extends AbstractParseTreeVisitor<T> implements LabeledExpr1Visitor<T> {
	 ...
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitAlfredo(LabeledExpr1Parser.AlfredoContext ctx) { return visitChildren(ctx); }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation returns the result of calling
	 ...
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitNothing(LabeledExpr1Parser.NothingContext ctx) { return visitChildren(ctx); }
}